...
exports.getUsers = exports.getUser = exports.validateUser = exports.createUser = void 0;
...
function getUser(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_model_1.default.findOne({ _id: id })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1: return [2 /*return*/, (_a.sent()).map(function (user) { return user.name; })];
            }
        });
    });
}
